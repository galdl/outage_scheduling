...
%     i_fig = 1+mod(i_plan-1,4);
    ...
    hold on;
    plotFill(monthlyCost(i_plan,:,1),monthlyCost(2,:,2),'b',opacity);
    hold off;
%     legend({'No outages - std','No outages - mean','Outage plan 1 - std','Outage plan 1 - mean'});
    ...
    hold on;
    plotFill(monthly_success_rate_values(i_plan,:,1),monthly_success_rate_values(2,:,2),'b',opacity);
    hold off;
%     legend({'No outages - std','No outages - mean','Outage plan 1 - std','Outage plan 1 - mean'});
    fontSize=17;
    set(gca,'fontsize',20);
    ...
    hold on;
    plotFill(monthly_lost_load(i_plan,:,1),monthly_lost_load(2,:,2),'b',opacity);
    hold off;
%     legend({'No outages - std','No outages - mean','Outage plan 1 - std','Outage plan 1 - mean'});
    fontSize=17;
    set(gca,'fontsize',20);
