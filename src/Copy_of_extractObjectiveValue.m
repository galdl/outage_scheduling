function [planValues,monthlyCost,contingenciesFrequency,planValuesVec,lostLoad] = Copy_of_extractObjectiveValue(iterationDir,N_plans,PLAN_DIRNAME_PREFIX,params)
...
for i_plan=1:N_plans
    ...
    if(numOfMonthsPerPlan(i_plan)<params.numOfMonths-2) %if not all months finished, dont use that data
