...
% fractionOfFinishedJobs=0.75;
% % set case params
% caseName='case9';%case5,case9,case14,case24
...
% parentDir='EVALUATION_run_2015-10-05-11-51-44';
...
% bestPlanVecTemp = cell(5,N_plans,N_CE);
%% navigate to the path
% load bestPlanVecFile_partial.mat % or not partial, depends
cd ../../../
params.dynamicSamplesPerDay=10;
jobArgs.jobNamePrefix='oldest';
temp='EVALUATION_oldest_2015-10-07-15-16-20';
fullLocalParentDir =['~/mount/Matlab/current_workspace/saved_runs/CE/',temp];
fullRemoteParentDir =['u/gald/Asset_Management/matlab/Matlab/current_workspace/saved_runs/CE/',temp];
N_CE=1;
i_CE=1;
...
%             ':wating for at least ',num2str(ceil(fractionOfFinishedJobs*jobsPerIteration)),...
%             ' of ',num2str(jobsPerIteration),' jobs...']);
%         timeOutCounter=0;
...
%         deleteUnnecessaryTempFiles(tempFilesDir);
        ...
        Copy_of_extractObjectiveValue(localIterDir,N_plans,PLAN_DIRNAME_PREFIX,params);
...
%         solutionStats(i_CE,4)=mean(S_sorted_includingNan(topI));
