function [split_data_loc,num_data_chunks] = split_and_save_data(final_db,sample_matrix,fullLocalParentDir,split_dir)
...
overall_length = size(sample_matrix,2); %should be identical to the length of final_db
